DBItest::make_context(
	...
	JDBC(h2_driver_class(), h2_jar()), list(url = "jdbc:h2:mem:dbi-test;DATABASE_TO_UPPER=FALSE", user = 'sa')
)
...
test_bdj_extras(skip = c(),
	default_driver_args = list(driverClass =h2_driver_class(), classPath = h2_jar())
)
