...
DBItest::make_context(
  dbj::driver(), list(url = "jdbc:derby:memory:dbi-test;create=true", user = 'sa'),
...
dbj_integration_test(
  skip = c(
    ...
    # TODO: temporary tables must be accessed in the SESSSION schema
    ...
    # Not an error: DBItest does not quote identifiers in select expressions.
    # https://github.com/rstats-db/DBItest/issues/64
    "write_table",
    "read_table",
