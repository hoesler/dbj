...
DBItest::make_context(
  dbj::driver(),
  list(url = "jdbc:mysql://localhost/dbi_test?useSSL=false", user = 'dbi_test', password = 'dbi_test'),
...
dbj_integration_test(
  skip = c(
    ...
    "data_date($|_.+)",                           # Not an error: timezone of the server might differ from R.
                                                  #   TODO: Set timezone after dbConnect (https://github.com/rstats-db/RMySQL/blob/master/R/connect.R)
