...
dbj_skips_global <- c(
  ...
  "stale_result_warning",                 # TODO: Currently I have no simple soulution how to keep track of results
  "data_logical_int($|_.+)",              # TODO: I don't understand these tests. Why and when should logicals be ints?
  ...
  "append_table_error",                   # TODO: append to nonexisting table should only fail if create = FALSE
  "overwrite_table",                      # TODO: similar to truncate?
  "roundtrip_logical_int",                # TODO: logicals are currently mapped to BOOLEAN not INT. Change?
